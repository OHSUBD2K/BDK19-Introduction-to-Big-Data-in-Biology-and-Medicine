...
**Team Lead(s):** Melissa Haendel, Shannon McWeeney
**Team Members:** Nicole Vasilevsky and Jackie Wirz

## Module Objectives:

At the completion of this component, the learner will be able to:

1. Identify some of the major issues with scientific reproducibility and how these can be addressed

**Module Prerequisites:** None

## Module Units
### Unit 1: Issues with Scientific Reproducibility

Unit 1 Slides: BDK19-1.pptx

Reading List: BDK19-1\_resources.pdf
